...
1. $$\sqroot{2}$$**<img src="https://render.githubusercontent.com/render/math?math=\sqrt[2]{}" style="background-color: #FFF">** : Square root of a number (e.g. <img src="https://render.githubusercontent.com/render/math?math=\sqrt[2]{144}"> = 12).
